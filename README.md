...
- 机器人模型来自 [MuJoCo Menagerie](https://github.com/google-deepmind/mujoco_menagerie)
- Buss, *Introduction to Inverse Kinematics* (2009)
- Khatib, *Operational Space Formulation* (1987)
- Tedrake, *Robotic Manipulation* (2023)
